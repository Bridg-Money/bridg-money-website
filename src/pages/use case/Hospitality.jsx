  ...
  return (
    <>
      <MetaData
        metas={{
          title:
            "Payment & Payout Solutions for Hospitality Businesses | BridgPay",
          desc: "BridgPay powers seamless financial flows for hospitality businesses. Enable fast vendor payments, staff disbursals, and smooth guest collections for hotels and travel operators.",
          ogTitle: "Seamless Financial Flows for Hospitality Businesses",
          ogDesc:
            "Improve guest experience with faster payments—BridgPay helps hotels, restaurants, and travel operators manage vendor payouts, staff payments, and collections efficiently.",
        }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-5 gap-y-10 relative">
          <div className="sm:px-15 flex items-center">
            <div className="relative p-2.5">
              <img
                src="/assets/images/useCase/benefit/Hospitality.webp"
