...
import BenefitImg from "../../assets/images/useCase/benefit/Real Estate.webp";
        ...
        <div className="px-6 pt-30 py-20 sm:px-15 xl:px-25">
          <div className="grid lg:grid-cols-2 gap-x-10 gap-y-5">
            <div className="flex items-center">
              <div>
                <TitleDecor title="Real Estate" clr="black" bgClr="white" />
                <TextFade>
                  <h1 className="text-5xl lg:text-[53px] font-semibold leading-15 text-white lg:leading-17 mb-3">
                    Transparent Payments for Real Estate Projects
                  </h1>
                  <p className="my-3 lg:my-4 text-lg text-white">
                    Real estate transactions involve high-value inflows and
                    frequent contractor and broker payouts. Delays reduce trust
                    and efficiency.
                  </p>
        ...
        <div className="grid lg:grid-cols-2 gap-x-10 gap-y-5">
          ...
          <div className="flex items-center">
            <p className="my-3 lg:my-4 text-lg">
              bridg.money supports multi-channel collections for buyer
              instalments, instant payouts for brokers/contractors, and
              connected banking for compliance-ready account monitoring.
            </p>
          </div>
        </div>
      </section>
