...
const Enterprise = () => {
  ...
  return (
    <>
      <MetaData
        metas={{
          title: "Enterprise-Grade Payment Infrastructure at Scale | BridgPay",
          desc: "BridgPay delivers secure, compliant, and scalable payment infrastructure for enterprises. Manage high-volume transactions, multiple subsidiaries, and global vendor payouts with confidence.",
          ogTitle: "Enterprise-Grade Payments at Scale",
          ogDesc:
            "Power enterprise financial operations with secure, compliant, and scalable payment solutions built to handle millions of transactions.",
        }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-5 gap-y-10 relative">
          <div className="sm:px-15 flex items-center">
            <div className="relative p-2.5">
              <img
                src="/assets/images/useCase/benefit/Enterprise.webp"
