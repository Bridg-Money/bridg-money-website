  ...
  return (
    <>
      <MetaData
        metas={{
          title:
            "Payment & Settlement Solutions for Retail & E-commerce | BridgPay",
          desc: "BridgPay enables fast, reliable settlements for retail and e-commerce businesses. Manage refunds, vendor payouts, and delivery partner payments with speed and accuracy.",
          ogTitle: "Fast, Reliable Settlements for Retail & E-commerce",
          ogDesc:
            "Build trust in online commerce with faster refunds, timely vendor payouts, and instant delivery partner payments using BridgPay.",
        }}
      />

      <section className=" bg-[linear-gradient(270deg,rgba(11,11,11,0)_0%,#0B0B0B_100%),url('/assets/images/useCase/hero-section/Retail-and-E-commerce.webp')] bg-cover h-screen bg-center flex items-center">
              ...
              <div>
                ...
                <TextFade>
                  <h1 className="text-5xl lg:text-[53px] font-semibold leading-15 text-white lg:leading-17 mb-3">
                    Fast, Reliable Settlements for Online Businesses
                  </h1>
                  <p className="my-3 lg:my-4 text-lg text-white">
                    Customers expect quick refunds. Vendors demand timely
                    payouts. Delivery partners rely on instant payments. For
                    e-commerce, financial operations define trust.
                  </p>
        ...
        <div className="grid lg:grid-cols-2 gap-x-10 gap-y-5">
          ...
          <div className="flex items-center">
            <p className="my-3 lg:my-4 text-lg">
              bridg.money powers bulk payouts for vendor settlements, delivery
              partner payments, and instant refunds. With collections APIs,
              handle COD remittances and digital transactions. Connected banking
              ensures full visibility into balances, settlements, and
              transactions.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-5 gap-y-10 relative">
          <div className="sm:px-15 flex items-center">
            <div className="relative p-2.5">
              <img
                src="/assets/images/useCase/benefit/Retail-&-E-commerce.webp"
