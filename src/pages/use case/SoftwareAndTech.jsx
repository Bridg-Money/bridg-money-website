...
import BenefitImg from "../../assets/images/useCase/benefit/Software & Tech.webp";
        ...
        <div className="px-6 pt-30 py-20 sm:px-15 xl:px-25">
          <div className="grid lg:grid-cols-2 gap-x-10 gap-y-5">
            <div className="flex items-center">
              <div>
                <TitleDecor title="Software & Tech" clr="black" bgClr="white" />
                <TextFade>
                  <h1 className="text-5xl lg:text-[53px] font-semibold leading-15 text-white lg:leading-17 mb-3">
                    Embedded Finance for Software & Tech Companies
                  </h1>
                  <p className="my-3 lg:my-4 text-lg text-white">
                    SaaS platforms and tech firms need smooth financial
                    operations for subscriptions, client payments, and embedded
                    financial services.
                  </p>
        ...
        <div className="grid lg:grid-cols-2 gap-x-10 gap-y-5">
          ...
          <div className="flex items-center">
            <p className="my-3 lg:my-4 text-lg">
              bridg.money allows tech companies to embed payouts for users,
              manage subscription collections, and leverage connected banking
              APIs for real-time transparency.
            </p>
          </div>
        </div>
      </section>
...
export default SoftwareAndTech;
