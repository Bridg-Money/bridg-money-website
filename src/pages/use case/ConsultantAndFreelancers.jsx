  ...
  return (
    <>
      <MetaData
        metas={{
          title:
            "Fast & Reliable Payments for Consultants & Freelancers | BridgPay",
          desc: "BridgPay helps consultants and freelancers get paid faster. Simplify client payments, reduce delays, and manage your funds with reliable payment solutions built for independent professionals.",
          ogTitle: "Get Paid Faster as a Freelancer or Consultant",
          ogDesc:
            "Eliminate delayed payments and manual fund management. BridgPay enables fast, secure client payments for freelancers and consultants.",
        }}
      />

      <section className=" bg-[linear-gradient(270deg,rgba(11,11,11,0)_0%,#0B0B0B_100%),url('/assets/images/useCase/hero-section/Consultants-and-Freelancers.webp')] bg-cover h-screen bg-center flex items-center">
              ...
              <div>
                ...
                <TextFade>
                  <h1 className="text-5xl lg:text-[53px] font-semibold leading-15 text-white lg:leading-17 mb-3">
                    Get Paid Faster as a Freelancer or Consultant
                  </h1>
                  <p className="my-3 lg:my-4 text-lg text-white">
                    Freelancers and consultants often face delayed client
                    payments and manual fund management.
                  </p>
        ...
        <div className="grid lg:grid-cols-2 gap-x-10 gap-y-5">
          ...
          <div className="flex items-center">
            <p className="my-3 lg:my-4 text-lg">
              bridg.money simplifies finances with collections APIs for client
              payments, payouts for instant withdrawals, and connected banking
              for full visibility.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-5 gap-y-10 relative">
          <div className="sm:px-15 flex items-center">
            <div className="relative p-2.5">
              <img
                src="/assets/images/useCase/benefit/Consultants-&-Freelancers.webp"
...
export default ConsultantAndFreelancers;
