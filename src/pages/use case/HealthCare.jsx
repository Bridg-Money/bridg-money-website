...
import BenefitImg from "../../assets/images/useCase/benefit/Healthcare.webp";
        ...
        <div className="px-6 pt-30 py-20 sm:px-15 xl:px-25">
          <div className="grid lg:grid-cols-2 gap-x-10 gap-y-5">
            <div className="flex items-center">
              <div>
                <TitleDecor title="Healthcare" clr="black" bgClr="white" />
                <TextFade>
                  ...
                  <p className="my-3 lg:my-4 text-lg text-white">
                    Hospitals, clinics, and pharmacies manage multiple inflows
                    (patients, insurance) and outflows (staff, vendors). Manual
                    processes delay care delivery.
                  </p>
        ...
        <div className="grid lg:grid-cols-2 gap-x-10 gap-y-5">
          ...
          <div className="flex items-center">
            <p className="my-3 lg:my-4 text-lg">
              bridg.money enables instant payouts to doctors, vendors, and
              staff, collections APIs for patient billing and insurance
              payments, and connected banking for real-time fund visibility.
            </p>
          </div>
        </div>
      </section>
